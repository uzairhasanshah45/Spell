...
import {vegetables1, vegetables2} from '../../shared/vegetable';
...
const Level2 = (props) => {
  ...
  const itemShuffle = () => {
    const array = [];
    console.log('item shuffle count level 2', count)
  ...
  const failedScreen = () => {
    return navigation.navigate('FailedScreen', {level: 2, image: images});
  };
